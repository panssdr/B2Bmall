<template>
  <div>
    <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
      <el-menu-item index="1" style="margin-left: 200px"><h2>一纺----后台管理系统</h2> </el-menu-item>

      <el-submenu index="2" style="float: right">
        <template #title>{{teacherName}}</template>
...
<script>
    export default {
        ...
        created() {
            ...
            console.log(JSON.parse(teaJson).name);
            this.teacherName = JSON.parse(teaJson).name;
        },
        methods:{
