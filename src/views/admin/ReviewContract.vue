<template>
 <div>
   <el-table :data="list" stripe style="width: 90%;margin: 0 auto" @row-click="getId">
     ...
     <el-table-column prop="id" label="客户账号"> </el-table-column>
     ...
     <el-table-column fixed="right" label="操作" width="100">
       <template  #default="scope">
         ...
         >
           <el-button type="text" size="small" slot="reference">审核订单合同</el-button>
         </el-popconfirm>
       </template>
     </el-table-column>
   </el-table>

   <el-dialog title="查看合同" :visible.sync="dialogFormVisible" width="70%">
...
export default {
  ...
  methods:{
    ...
    detail(id){
      ...
      //括号里参数是数据库里保存着的富文本内容字段，content为数据库所对应的字段
